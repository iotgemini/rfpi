...
echo '<form name="peri10_btn_gpio_functions" action="./cmd_set_input_setting.php" method=GET>';
...
//echo '<td class="td_peripheral">With signal input GPIO0 changes output:</td>';  
...
// IN0
echo '<tr class="table_title_field_line">'; 
echo '<td class="td_peripheral" colspan=1>IN0<br>'.$lang_title_low_trigger.'</td>';    
echo '<td class="td_peripheral" colspan=1>IN0<br>'.$lang_title_high_trigger.'</td>';
echo '<td class="td_peripheral">IN0<br>'.$lang_title_enabled.'</td>';  
echo '</tr>';

echo '<tr class="table_line_even" >';
echo '<td class="td_peripheral" align=center >';
echo '<input type="text" name="IN0_trigger_low" value="'; 
	//echo number_format((float)strval(voltage_0to10V_from_8bit_value_peri10($IN0_trigger_low)), 0, '.', ''); 
	echo str_voltage_0to10V_from_8bit_value_peri10($IN0_trigger_low);
echo '" size="4" maxlength="4">';
echo '<br>(0 - 10V)';
echo '</td>';    
echo '<td class="td_peripheral" align=center>';
echo '<input type="text" name="IN0_trigger_high" value="'; 
	//echo number_format((float)strval(voltage_0to10V_from_8bit_value_peri10($IN0_trigger_high)), 0, '.', ''); 
	echo str_voltage_0to10V_from_8bit_value_peri10($IN0_trigger_high);
echo '" size="4" maxlength="4">';
echo '<br>(0 - 10V)';
echo '</td>';  

echo '<td class="td_peripheral" align=center rowspan=2>';
if(intval($IN0_enabled, 10)==0){
	echo '<input type="checkbox" name="IN0_enabled" value="0" onchange="if(this.value==0) this.value=1; else this.value=0;">';
}else{
	echo '<input type="checkbox" name="IN0_enabled" value="1" onchange="if(this.value==0) this.value=1; else this.value=0;" checked>';
}
echo '</td>';
echo '</tr>';
...
echo '<td class="td_peripheral" colspan=2 align=center >';
	if(intval($IN0_enabled, 10)==2){
		echo '<input type="radio" name="IN0_output_to_control" value="1" >&nbsp'.$lang_relay;
		echo '&nbsp;&nbsp;<input type="radio" name="IN0_output_to_control" value="2" checked="checked">&nbspGPIO1';
	}else{
		echo '<input type="radio" name="IN0_output_to_control" value="1" checked="checked">&nbsp'.$lang_relay;
		echo '&nbsp;&nbsp;<input type="radio" name="IN0_output_to_control" value="2">&nbspGPIO1';
	}
echo '</td>';
echo '</tr>';
...
echo '<input type="text" name="IN1_trigger_low" value="'; 
	//echo number_format((float)strval(voltage_0to10V_from_8bit_value_peri10($IN1_trigger_low)), 0, '.', ''); 
	echo str_voltage_0to10V_from_8bit_value_peri10($IN1_trigger_low);
echo '" size="4" maxlength="4">';
echo '<br>(0 - 10V)';
echo '</td>';    
echo '<td class="td_peripheral" align=center>';
echo '<input type="text" name="IN1_trigger_high" value="'; 
	//echo number_format((float)strval(voltage_0to10V_from_8bit_value_peri10($IN1_trigger_high)), 0, '.', ''); 
	echo str_voltage_0to10V_from_8bit_value_peri10($IN1_trigger_high);
echo '" size="4" maxlength="4">';
echo '<br>(0 - 10V)';
echo '</td>';  
