...
//                                                        
var dht22 = draw2d.SetFigure.extend({            
    ...
    createSet: function()
    {
        this.canvas.paper.setStart();
         ...
         shape.attr({"stroke":"#303030","stroke-width":1,"fill":"#ece3dd","dasharray":null,"opacity":1});
         shape.data("name","Rectangle");
         ...
         shape.attr({"stroke":"none","stroke-width":0,"fill":"#eee","dasharray":null,"opacity":1});
         shape.data("name","Rectangle");
