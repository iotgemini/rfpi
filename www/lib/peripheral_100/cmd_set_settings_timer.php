...
$status_to_set=$_GET['status_to_set'];

if($timer_enabled==="1"){
	//if($output_to_control==="1") 
	//$timer_enabled = "01";
	//else if($output_to_control==="2") $timer_enabled = "02";
	//$timer_enabled = "0" . $output_to_control;
	
	if($status_to_set==="1") $status_to_set = "8"; //last bit at 1	
	else if($status_to_set==="2") $status_to_set = "4"; //the bit before last bit at 1	
	else $status_to_set = "0"; 
	$timer_enabled = $status_to_set . $output_to_control;
	//echo $timer_enabled;
}else{
	$timer_enabled = "00";
}
...
$TAG1="RF";
$TAG2=$address_peri;
$TAG3="524266" . $id_hex_special_function . $timer_enabled . $byte_H_timer_ms . $byte_L_timer_ms . $byte_timer_SS . $byte_timer_MM . $byte_timer_HH .  "2E2E2E2E2E2E";
