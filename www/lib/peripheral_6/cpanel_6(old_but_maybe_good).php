...
//		function peripheral_6($id, $idperipheral, $name, $address, $numInput, $numOutput, $arrayNameInput, $arrayStatusInput, $arrayNameOutput, $arrayStatusOutput);
...
function peripheral_6($id, $idperipheral, $name, $address, $numInput, $numOutput, $arrayNameInput, $arrayStatusInput, $arrayNameOutput, $arrayStatusOutput){
	...
	echo '<input type=hidden name="address_peri" value="'.$address.'">';
