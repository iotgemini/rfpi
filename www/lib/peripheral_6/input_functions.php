...
echo '<td class="td_peripheral">FUNCTION</td>';  
echo '<td class="td_peripheral">ENABLED</td>';  
echo '</tr>';

echo '<tr class="table_line_even">';
echo '<td class="td_peripheral">Change Relay status from the input.<br>(each impulse on the input will change the Relay status)</td>';  
