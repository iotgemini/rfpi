...
echo '<form name="peri7_btn_gpio_functions" action="./cmd_set_input_setting.php" method=GET>';
...
echo '<input type="text" name="IN0_trigger_low" value="'; 
	//echo number_format((float)strval(voltage_0to10V_from_8bit_value_peri7($IN0_trigger_low)), 0, '.', ''); 
	echo str_voltage_0to10V_from_8bit_value_peri7($IN0_trigger_low);
echo '" size="4" maxlength="4">';
echo '<br>(0 - 5V)';
echo '</td>';    
echo '<td class="td_peripheral" align=center>';
echo '<input type="text" name="IN0_trigger_high" value="'; 
	//echo number_format((float)strval(voltage_0to10V_from_8bit_value_peri7($IN0_trigger_high)), 0, '.', ''); 
	echo str_voltage_0to10V_from_8bit_value_peri7($IN0_trigger_high);
echo '" size="4" maxlength="4">';
echo '<br>(0 - 5V)';
echo '</td>';  
...
echo '<input type="text" name="IN1_trigger_low" value="'; 
	//echo number_format((float)strval(voltage_0to10V_from_8bit_value_peri7($IN1_trigger_low)), 0, '.', ''); 
	echo str_voltage_0to10V_from_8bit_value_peri7($IN1_trigger_low);
echo '" size="4" maxlength="4">';
echo '<br>(0 - 5V)';
echo '</td>';    
echo '<td class="td_peripheral" align=center>';
echo '<input type="text" name="IN1_trigger_high" value="'; 
	//echo number_format((float)strval(voltage_0to10V_from_8bit_value_peri7($IN1_trigger_high)), 0, '.', ''); 
	echo str_voltage_0to10V_from_8bit_value_peri7($IN1_trigger_high);
echo '" size="4" maxlength="4">';
echo '<br>(0 - 5V)';
echo '</td>';  
