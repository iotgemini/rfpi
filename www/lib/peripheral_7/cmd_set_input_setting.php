...
$IN0_trigger_low_INT = (int)value_8bit_from_voltage_0to10V_peri7($IN0_trigger_low_INT);
...
$IN0_trigger_high_INT = (int)value_8bit_from_voltage_0to10V_peri7($IN0_trigger_high_INT);  
...
$IN1_trigger_low_INT = (int)value_8bit_from_voltage_0to10V_peri7($IN1_trigger_low_INT);
...
$IN1_trigger_high_INT = (int)value_8bit_from_voltage_0to10V_peri7($IN1_trigger_high_INT);
