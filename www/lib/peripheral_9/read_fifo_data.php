...
$next_page_name = "functions_data.php";
...
function data_got_then_give_to_next_page($data_radio,$next_page_name,$address_peri,$position_id,$redirect_page){
					...
					$sem_status_send_array_temperature_pyrometer = intval($data_radio[8] . $data_radio[9], 16); 
					$time_between_samples = intval($data_radio[10] . $data_radio[11], 16); 
					$temp0 = intval($data_radio[12] . $data_radio[13], 16);
					...
					$array_data = array($temp0,$temp1,$temp2,$temp3,$temp4,$temp5,$temp6,$temp7,$temp8,$temp9);	
					...
					.'&sem_status_send_array_temperature_pyrometer='.$sem_status_send_array_temperature_pyrometer
