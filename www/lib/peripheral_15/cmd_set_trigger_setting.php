...
if($trigger_enabled==="1"){
	...
	else if($output_to_control==="3") $trigger_enabled = "03";
}else{
	$trigger_enabled = "00";
}
...
//	$int_trigger_temperature_low_INT = (int)the_8bit_value_from_temperature_MCP9701_peri_15($int_trigger_temperature_low_INT);
//}else{
	$int_trigger_temperature_low_INT = (int)the_8bit_value_from_temperature_MCP9701_peri_15_FW2($int_trigger_temperature_low_INT);
//}
...
//if(FORMULA_TO_USE_BASED_ON_FW_VERSION == 1){
//if($fw_version_peri == 1){
//	$int_trigger_temperature_high_INT = (int)the_8bit_value_from_temperature_MCP9701_peri_15($int_trigger_temperature_high_INT);
//}else{
	$int_trigger_temperature_high_INT = (int)the_8bit_value_from_temperature_MCP9701_peri_15_FW2($int_trigger_temperature_high_INT);
//}
...
if($send_temperature_enabled==="1"){
	...
	//if(FORMULA_TO_USE_BASED_ON_FW_VERSION == 1){
	//if($fw_version_peri == 1){
	//	$int_temperature_offset_to_send_data_temperature = (int)the_8bit_value_from_temperature_MCP9701_peri_15($int_temperature_offset_to_send_data_temperature);
	//}else{
		$int_temperature_offset_to_send_data_temperature = (int)the_8bit_value_from_temperature_MCP9701_peri_15_FW2($int_temperature_offset_to_send_data_temperature);
	//}
...
//echo '<br>int_temperature_offset_to_send_data_temperature='.$int_temperature_offset_to_send_data_temperature . ' = ' . $byte_temperature_offset_to_send_data_temperature .'<br>';
