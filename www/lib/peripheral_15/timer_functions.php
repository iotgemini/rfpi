...
if(intval($timer_enabled, 10)==2){
	...
	echo '<br><input type="radio" name="output_to_control" value="4">&nbspSV2';
}else if(intval($timer_enabled, 10)==4){
	echo '<input type="radio" name="output_to_control" value="1" >&nbsp'.$lang_relay.'1';
	echo '<input type="radio" name="output_to_control" value="2" >&nbsp'.$lang_relay.'2';
	echo '<br><input type="radio" name="output_to_control" value="4" checked="checked">&nbspSV2';
}else{
