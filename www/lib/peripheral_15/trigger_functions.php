...
//http://192.168.43.110/lib/peripheral_15/trigger_functions.php?address_peri=0001&fw_version_peri=2&position_id=0
//&trigger_enabled=1
//&trigger_temperature_low_INT=78
//&trigger_temperature_low_DEC=0
//&trigger_temperature_high_INT=79
//&trigger_temperature_high_DEC=0
//&temperature_offset_to_send_data_temperature=21
//&current_temperature_INT=84
//&current_temperature_DEC=1
...
//		echo number_format((float)strval(temperature_MCP9701_from_8bit_value_peri_15($trigger_temperature_low_INT)), 0, '.', ''); 
//	}else{
		echo number_format((float)strval(temperature_MCP9701_from_8bit_value_peri_15_FW2($trigger_temperature_low_INT)), 0, '.', ''); 
//	}
...
echo '<input type="text" name="trigger_temperature_high_INT" value="'; 
	//if(FORMULA_TO_USE_BASED_ON_FW_VERSION == 1){
//	if($fw_version_peri == 1){
//		echo number_format((float)strval(temperature_MCP9701_from_8bit_value_peri_15($trigger_temperature_high_INT)), 0, '.', ''); 
//	}else{
		echo number_format((float)strval(temperature_MCP9701_from_8bit_value_peri_15_FW2($trigger_temperature_high_INT)), 0, '.', ''); 
//	}
echo '" size="2" maxlength="2">';
...
echo '<td class="td_peripheral" colspan=2 align=center >';
	if(intval($trigger_enabled, 10)==2){
		echo '<input type="radio" name="output_to_control" value="1" >&nbsp'.$lang_relay.'1';
		echo '<input type="radio" name="output_to_control" value="2"  checked="checked">&nbsp'.$lang_relay.'2';
		echo '&nbsp;&nbsp;<input type="radio" name="output_to_control" value="3" >&nbspSV2';
	}else if(intval($trigger_enabled, 10)==3){
		echo '<input type="radio" name="output_to_control" value="1" >&nbsp'.$lang_relay.'1';
		echo '<input type="radio" name="output_to_control" value="2" >&nbsp'.$lang_relay.'2';
		echo '&nbsp;&nbsp;<input type="radio" name="output_to_control" value="3" checked="checked">&nbspSV2';
	}else{
		echo '<input type="radio" name="output_to_control" value="1" checked="checked">&nbsp'.$lang_relay.'1';
		echo '<input type="radio" name="output_to_control" value="2" >&nbsp'.$lang_relay.'2';
		echo '&nbsp;&nbsp;<input type="radio" name="output_to_control" value="3" >&nbspSV2';
	}
echo '</td>';
...
echo '<input type="text" name="temperature_offset_to_send_data_temperature" value="'; 
	//if(FORMULA_TO_USE_BASED_ON_FW_VERSION == 1){
	if($fw_version_peri == 1){
		echo number_format((float)temperature_MCP9701_from_8bit_value_peri_15($temperature_offset_to_send_data_temperature), 0, '.', ''); 
	}else{	
		echo number_format((float)temperature_MCP9701_from_8bit_value_peri_15_FW2($temperature_offset_to_send_data_temperature), 0, '.', '');
	}
