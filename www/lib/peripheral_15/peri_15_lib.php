...
//	function mcu_volt_peri_15($ADC_10bit_value);														//return the volts of the power supply applied to the MCU

//	function str_mcu_volt_peri_15($ADC_10bit_value);													//return a string that contain the volts of the power supply applied to the MCU

//	function voltage_0to5V_from_10bit_value_peri_15($ADC_10bit_value);									//return the value in Volt

//	function ADC10bit_from_voltage_0to5V_peri_15($milliVolt,$MCU_Volts_raw_value);						//return the ADC value on 10bits from the value in milli Volt

//	function str_voltage_0to5V_from_10bit_value_peri_15($ADC_10bit_value);								//return a string that contain the value in Volt of the ADC 10bit resolution

//	function temperature_DHT11_from_raw_value_peri_15($raw_value);										//return a string with the value of the temperature converted from the raw value read from the sensor DHT11

//	function humidity_DHT11_from_raw_value_peri_15($raw_value);										//return a string with the value of the humidity converted from the raw value read from the sensor DHT11

//	function tempORhumid_DHT11_from_threshold_value_peri_15($raw_value);								//return the value of the Temperature OR Humidity set for the threshold functions

//	function threshold_value_from_tempORhumid_DHT11_peri_15($temperature);								//return the value to set into the peri for the threshold functions from the Temperature OR Humidity value choosen by user

//	function temperature_MCP9701_from_ADC_raw_value_peri_15($ADC_value,$MCU_Volts_raw_value);			//return the temperature from ADC value where is connected the MCP9701 sensor
	
//	function temperature_MCP9701_from_8bit_value_peri_15($ADC_8bit_value); 							//return the temperature in �C

//	function the_ADC10bit_value_from_temperature_MCP9701_peri_15($temperature, $MCU_Volts_raw_value); 	//return 10bits on 2bytes of the ADC raw value of the temperature
...
//define("DIRECTORY_CSS_PERI_15", "/lib/peripheral_15/css/"); 					//where all default style for any peripheral are kept
...
//echo '<link rel="stylesheet" href="' . DIRECTORY_CSS_PERI_15 . 'slider.css" type="text/css" >';
...
function str_mcu_volt_peri_15($ADC_10bit_value){
	$voltage="";
	$voltage_int = mcu_volt_peri_15($ADC_10bit_value);
...
function voltage_0to5V_from_10bit_value_peri_15($ADC_10bit_value,$MCU_Volts_raw_value){ 
...
function str_voltage_0to5V_from_10bit_value_peri_15($ADC_10bit_value,$MCU_Volts_raw_value){
	$voltage="";
	//$voltage=number_format((float)strval(voltage_0to5V_from_10bit_value_peri_15($ADC_10bit_value)), 0, '.', ''); 
	$voltage_int = voltage_0to5V_from_10bit_value_peri_15($ADC_10bit_value,$MCU_Volts_raw_value);
	$voltage_int = $voltage_int * 100;
	$voltage_int = ceil($voltage_int);
	$voltage_int = $voltage_int / 100;
	$voltage = number_format($voltage_int, 2, '.', ''); 
...
function temperature_DHT11_from_raw_value_peri_15($raw_value){
...
function humidity_DHT11_from_raw_value_peri_15($raw_value){
...
function temperature_DHT22_from_raw_value_peri_15($raw_value){
	$temperature = $raw_value & 0x0000FFFF;
	return $temperature/10 ;
}

function humidity_DHT22_from_raw_value_peri_15($raw_value){
	$humidity = $raw_value >> 16;
	return $humidity/10 ;
}

function tempORhumid_DHT11_from_threshold_value_peri_15($raw_value){
...
function threshold_value_from_tempORhumid_DHT11_peri_15($temperature){
