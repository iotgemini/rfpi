...
//	function temperature_MCP9701_from_8bit_value_peri_99($ADC_8bit_value); 	//return the temperature in °C

//	function the_8bit_value_from_temperature_MCP9701_peri_99($tempearure); 	//return the byte of the temperature

//	function voltage_0to10V_from_8bit_value_peri_99($ADC_8bit_value);		//return the value between 0V and 10V from the byte readed by the ADC

//	function str_voltage_0to10V_from_8bit_value_peri_99($ADC_8bit_value);	//return the string with the value between 0V and 10V from the byte readed by the ADC

//	function value_8bit_from_voltage_0to10V_peri_99($voltage_0to10_value);	//return a byte from a value between 0V and 10V
...
//define("DIRECTORY_IMG_PERI_99", "./lib/peripheral_99/img/"); 		//where all pictures are kept
//define("DIRECTORY_CSS_PERI_99", "./lib/peripheral_99/css/"); 		//where all pictures are kept

define("DIRECTORY_IMG_PERI_99", "/img/peripheral/"); 		//where all default pictures for any peripheral are kept
define("DIRECTORY_CSS_PERI_99", "/css/"); 					//where all default style for any peripheral are kept
...
function temperature_MCP9701_from_8bit_value_peri_99($ADC_8bit_value){
...
function the_8bit_value_from_temperature_MCP9701_peri_99($tempearure){
	$value_8bit = (($tempearure * 256) / MAX_TEMPERATURE_MCP9701)+MIN_TEMPERATURE_MCP9701; 
	//$value_8bit = ceil($value_8bit);
	return $value_8bit;
}

function voltage_0to10V_from_8bit_value_peri_99($ADC_8bit_value){
...
function str_voltage_0to10V_from_8bit_value_peri_99($ADC_8bit_value){
	$voltage="";
	//$voltage=number_format((float)strval(voltage_0to10V_from_8bit_value_peri_99($ADC_8bit_value)), 0, '.', ''); 
	$voltage_int = voltage_0to10V_from_8bit_value_peri_99($ADC_8bit_value);
...
function value_8bit_from_voltage_0to10V_peri_99($voltage_0to10_value){
...
function temperature_pyrometer_peri_99($ADC_8bit_value){
...
function str_temperature_pyrometer_peri_99($ADC_8bit_value){
	$temperature = temperature_pyrometer_peri_99($ADC_8bit_value);
