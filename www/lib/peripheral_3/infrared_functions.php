...
Description: this is a control pannel for the special function (INFRARED) of the peripheral number 3
...
//button Record New Signal
echo '<p align=center>';
echo '<a href="./cmd_record_signal.php?address_peri='.$address_peri.'" class="btn_cmd">Record New Signal</a>';
echo '</p>';
...
//button Transmit MEM
echo '<p align=center>';
//button Transmit MEM0
echo '<a href="./cmd_transmit_signal_mem0.php?address_peri='.$address_peri.'" class="btn_cmd">Transmit MEM0</a>';
//button Transmit MEM1
echo ' <a href="./cmd_transmit_signal_mem1.php?address_peri='.$address_peri.'" class="btn_cmd">Transmit MEM1</a>';
echo '</p>';
...
//button SHOW SIGNALS
echo '<form name="home" action="./infrared_functions.php" method=GET>';
...
if(file_exists("./db/".$address_peri."_db_infrared_signals.txt")){
	...
	while(feof($handle)!==TRUE){ 
		...
		if($data=fgets($handle)){
				...
				echo '<form name="peri3_btn_infrared_functions" action="./start_send_packet_signal.php" method=GET>';
				echo '<input type=hidden name="address_peri" value="'. $address_peri . '">';
				...
				echo '<input type=submit value="TRANSMIT" class="btn_functions">';
				//echo '<br><br><br>';
