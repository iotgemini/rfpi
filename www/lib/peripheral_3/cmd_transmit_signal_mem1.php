...
Description: it send the command to transmit the signal data of the MEM1
...
$strCmd = "DATA RF ".$address_peri." 52426608012E2E2E2E2E2E2E2E2E2E2E2E "; //the space at the end is important

writeFIFO(FIFO_GUI_CMD, $strCmd);

if($redirect_page)
	if($redirect_page === "cmd_save_signal_in_mem1")
